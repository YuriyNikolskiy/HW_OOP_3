...
public class Main {
    public static void main(String[] args) {
        StudyGroup studyGroup1 = new StudyGroup(1, "Group1");
        StudyGroup studyGroup2 = new StudyGroup(2, "Group2");
        StudyGroup studyGroup3 = new StudyGroup(3, "Group3");
        StudyGroup studyGroup4 = new StudyGroup(4, "Group4");
        StudyGroup studyGroup5 = new StudyGroup(5, "Group5");
        StudyGroup studyGroup6 = new StudyGroup(6, "Group6");
        StudyGroup studyGroup7 = new StudyGroup(7, "Group7");
        StudyGroup studyGroup8 = new StudyGroup(8, "Group8");
